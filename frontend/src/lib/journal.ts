// The journal has no auth — "who" is just a name the browser remembers. Kept here so the
// map-level feed and both drawers read/write the same value.

const AUTHOR_KEY = 'vs:journal-author'
